...
#define JUCE_ObjCExtraSuffix           tal_filter_2
...
*/
#define JucePlugin_Name                     "TAL Filter 2 Plugin"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "TAL-Filter-2"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               '025e'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           TalFilterAU

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "TalFilterAU"
...
*/
#define JucePlugin_CFBundleIdentifier       "ch.toguaudioline.talfilter2"
...
*/
#define JucePlugin_AUCocoaViewClassName     TalFilter2_v10

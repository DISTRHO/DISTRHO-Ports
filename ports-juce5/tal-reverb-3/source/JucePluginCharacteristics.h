...
*/
#define JucePlugin_Name                     "TAL Reverb III Plugin"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "TAL-Reverb-III"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'REV3'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           TalReverb3AU

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "TalReverb3AU"
...
*/
#define JucePlugin_CFBundleIdentifier       "ch.toguaudioline.talreverb3"
...
*/
#define JucePlugin_AUCocoaViewClassName     TalReverb3_v08

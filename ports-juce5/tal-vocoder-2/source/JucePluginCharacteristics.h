...
#define JUCE_ObjCExtraSuffix           tal_vocoder2
...
*/
#define JucePlugin_Name                     "TAL Vocoder II Plugin"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "TAL-Vocoder-II"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'VOC2'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           TalVocoder2AU

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "TalVocoder2AU"
...
*/
#define JucePlugin_CFBundleIdentifier       "ch.toguaudioline.talvocoder2"
...
*/
#define JucePlugin_AUCocoaViewClassName     TalVocoder2_01

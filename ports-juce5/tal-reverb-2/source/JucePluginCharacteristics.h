...
#define JUCE_ObjCExtraSuffix           tal_reverb2
...
*/
#define JucePlugin_Name                     "TAL Reverb II Plugin"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "TAL-Reverb-II"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               '58h8'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           TalReverb2AU

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "TalReverb2AU"
...
*/
#define JucePlugin_CFBundleIdentifier       "ch.toguaudioline.talreverb2"
...
*/
#define JucePlugin_AUCocoaViewClassName     TalReverb2_v09

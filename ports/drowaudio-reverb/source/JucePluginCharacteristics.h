...
*/
#define JucePlugin_Name                     "dRowAudio Reverb"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "A Reverb Plugin"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'Rvrb'								// needs changing
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           dRowAudio_Reverb

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "dRowAudio_Reverb"
...
*/
#define JucePlugin_CFBundleIdentifier       "dRowAudio: Reverb"
 ...
 */
#define JucePlugin_AUCocoaViewClassName     dRowAudio_Reverb_V1
//==============================================================================
/*                                RTAS settings                               */

...
#ifndef __JUCETICE_DRUMSYNTHCOMPONENT_HEADER__
#define __JUCETICE_DRUMSYNTHCOMPONENT_HEADER__

#include "DrumSynthPlugin.h"
#include "Components/DrumSynthMain.h"
...
*/
class DrumSynthComponent  : public AudioProcessorEditor,

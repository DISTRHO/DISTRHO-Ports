...
/**	Gets the MIDI Controller number.
	@return int The controller number. */	
	int getControllerNumber();
	
/**	Sets the MIDI Controller number.
	@param int The new number. */		
	void setControllerNumber(int newNumber);
...
private:
	...
	float midiControllerNumber;	// Midi Controller Number

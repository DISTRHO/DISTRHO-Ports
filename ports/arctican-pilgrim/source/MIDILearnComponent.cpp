...
int PluginParameter::getControllerNumber()					{return midiControllerNumber;}
void PluginParameter::setControllerNumber(int newNumber)	{midiControllerNumber = newNumber;}

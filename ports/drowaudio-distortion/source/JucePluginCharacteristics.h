...
*/
#define JucePlugin_Desc                     "A Distortion Plugin"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'Dist'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           dRowAudio_Distortion

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "dRowAudio_Distortion"
...
*/
#define JucePlugin_CFBundleIdentifier       "com.dRowAudio.${PRODUCT_NAME:identifier}"

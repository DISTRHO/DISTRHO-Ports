...
#define JucePlugin_PluginCode           'Fnct'
...
#define JucePlugin_CFBundleIdentifier   com.arcticanaudio.TheFunction
#define JucePlugin_AUCocoaViewClassName TheFunctionProjectAU_V1

...
*/
#define JucePlugin_Name                     "dRowAudio DistortionShaper"						// needs changing

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "A Distortion Shaper Plugin"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'DShp'								// needs changing
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           dRowAudio_DistortionShaper

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "dRowAudio_DistortionShaper"
...
*/
#define JucePlugin_CFBundleIdentifier       "dRowAudio: Distortion Shaper"
 ...
 */
#define JucePlugin_AUCocoaViewClassName     dRowAudio_DistortionShaper_V1
//==============================================================================
/*                                RTAS settings                               */

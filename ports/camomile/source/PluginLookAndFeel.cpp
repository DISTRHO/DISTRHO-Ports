...
Image const& CamoLookAndFeel::getImage()
{
    ...
    {
        File const f(CamomileEnvironment::getPatchPath() + "/" + String(CamomileEnvironment::getImageName()));
        if(f.exists())
        {
...
String const& CamoLookAndFeel::getDescription()
{
    ...
    if(!loaded)
    {
        ...
        {
            File const f(CamomileEnvironment::getPatchPath() + "/" + String(CamomileEnvironment::getPatchDescription()));
            if(f.exists())
            {
